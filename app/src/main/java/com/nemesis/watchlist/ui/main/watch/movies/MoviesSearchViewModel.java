...
import com.nemesis.watchlist.data.repository.MoviesSearchRepositoryImpl;
...
public class MoviesSearchViewModel extends ViewModel {
    ...
    private MoviesSearchRepositoryImpl moviesSearchRepoImpl;

    public MoviesSearchViewModel(){
        moviesSearchRepoImpl = new MoviesSearchRepositoryImpl();
    }


    public void getMovies(String language, String query) {
        moviesSearchRepoImpl.getMovies(language, query)
